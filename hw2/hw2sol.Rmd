...
fizzbuzz <- function(x){
  ...
  kable(results_table, align = 'c')
    ...
    b) The fizzbuzz function will transform input into a vector and remove all invalid inputs with valid inputs left, let's try on invalid, semi-invalid, and good inputs.
