...
0. What's the output of following bash script?
    ...
    ```
display all csv files in the directory `/home/m280data/NYCHVS` without changing your current directory
...
# uniq -c shows how many times this element occurs in the frofile
```
...
The first line tells the system to use `/bin/sh` as interprater to run the following script.
...
Rscript runSim.R  n=100 dist=\"gaussian\" # pass string into R
```
